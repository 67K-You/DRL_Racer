...
class PPO(OnPolicyAlgorithm):
    ...
    def train(self, from_pre_trained: bool) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                # Weight importance computed if transfer learning is required
                if from_pre_trained:
                    rewards = np.sum(rollout_data.rewards.cpu().numpy())
                    weights = (1 / 90) * (rewards)
                ...
                # Computation of the loss considering the weight importance
                if from_pre_trained:
                    loss = weights * (policy_loss + self.ent_coef * entropy_loss + self.vf_coef * value_loss)
                else:
    ...
    def learn(
        ...
        return super().learn(
            ...
            from_pre_trained=from_pre_trained
        )
